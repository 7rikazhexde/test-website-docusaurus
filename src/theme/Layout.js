  ...
  ja: {
    consentText: (
      <span>
        ...
        詳細については、<a href="https://7rikazhexde.github.io/test-website-docusaurus/ja/docs/about" style={linkStyle}>こちら</a>をご覧ください。
      </span>
    ),
    buttonText: '同意する',
  ...
  en: {
    consentText: (
      <span>
        ...
        For more details, please see <a href="https://7rikazhexde.github.io/test-website-docusaurus/docs/about" style={linkStyle}>here</a>.
      </span>
    ),
    buttonText: 'Agree',
...
export default function Layout(props) {
  ...
  const handleDeclineCookie = () => {
    if (ExecutionEnvironment.canUseDOM) {
      Cookies.set('docusaurus-gdpr-google-analytics', 'false', { expires: 150 });
      window.location.reload();
    }
  };
